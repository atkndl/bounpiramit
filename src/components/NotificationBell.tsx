...
export function NotificationBell() {
  ...
  const handleNotificationClick = async (notification: any) => {
    ...
    if (notification.type === 'message') {
      navigate(`/mesajlar?userId=${notification.from_user_id}`);
    } else if (notification.type === 'like' && notification.item_id) {
      navigate('/piramit'); // Could navigate to specific post in future
    }
